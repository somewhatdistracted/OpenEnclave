...
copy_mverilog: clean
	cp verilog/openlane_rtl/user_proj_example.v skywater-digital-flow/OpenEnclave/design/rtl/design.v
	cp verilog/dv/user_proj_example_tb.v skywater-digital-flow/OpenEnclave/design/testbench/user_proj_example_tb.sv
