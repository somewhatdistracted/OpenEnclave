...
# construct.py
#=========================================================================
# Mflowgen defs for OpenEnclave
# Built of demo with 16-bit GcdUnit
#
# Author      : Priyanka Raina
# Date        : December 4, 2020
# Modified by : Ian MacFarlane and JD Kelly
# Date        : May 25, 2022
...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'user_proj_example', #was: user_project_example
    'clock_period'   : 20.0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    'topographical'  : True,
